...
from app.api.routes.movie_requests import router as movie_requests_router
...
api_router.include_router(movie_requests_router, prefix="/movie-requests", tags=["movie-requests"])
