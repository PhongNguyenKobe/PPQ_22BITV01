...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./entry-styles.Drc-oNUD.mjs').then(interopDefault),
  "pages/showtimes.vue": () => import('./showtimes-styles.CKIBy80g.mjs').then(interopDefault),
