    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="material-symbols-outlined text-sm"${_scopeId}>arrow_back</span> Quay l\u1EA1i B\u1EAFp N\u01B0\u1EDBc `);
          } else {
            return [
              createVNode("span", { class: "material-symbols-outlined text-sm" }, "arrow_back"),
              createTextVNode(" Quay l\u1EA1i B\u1EAFp N\u01B0\u1EDBc ")
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`<h1 class="font-headline-lg text-2xl md:text-3xl font-black text-on-surface"> Thanh To\xE1n \u0110\u01A1n V\xE9 </h1></div><div class="flex items-center gap-3 text-[10px] md:text-xs font-bold bg-surface-container-low border border-white/10 px-4 py-2.5 rounded-full overflow-x-auto whitespace-nowrap hide-scrollbar max-w-full"><span class="text-on-surface-variant flex items-center gap-1"><span class="material-symbols-outlined text-[14px]">check_circle</span> Gh\u1EBF</span><span class="text-on-surface-variant">/</span><span class="text-on-surface-variant flex items-center gap-1"><span class="material-symbols-outlined text-[14px]">check_circle</span> Combo</span><span class="text-on-surface-variant">/</span><span class="text-primary-container">3. Thanh To\xE1n</span></div></div><div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start"><div class="lg:col-span-8 space-y-6"><div class="glass-panel border border-glass-stroke rounded-2xl p-6 md:p-8"><h3 class="font-bold text-lg text-on-surface mb-6 flex items-center gap-2"><span class="material-symbols-outlined text-primary-container">payment</span> Ch\u1ECDn Ph\u01B0\u01A1ng Th\u1EE9c Thanh To\xE1n </h3><div class="grid grid-cols-1 md:grid-cols-2 gap-4"><!--[-->`);
...
//# sourceMappingURL=payment-2Sa96N7s.mjs.map
