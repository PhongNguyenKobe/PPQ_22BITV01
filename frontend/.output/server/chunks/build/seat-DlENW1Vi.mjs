...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<h1 class="font-headline-lg text-2xl md:text-3xl font-black text-on-surface"> Ch\u1ECDn Gh\u1EBF Ng\u1ED3i Th\xF4ng Minh </h1></div><div class="flex items-center gap-3 text-xs font-bold bg-surface-container-low border border-glass-stroke px-4 py-2.5 rounded-full"><span class="text-primary-container">1. Ch\u1ECDn Gh\u1EBF</span><span class="text-on-surface-variant">/</span><span class="text-on-surface-variant">2. Thanh To\xE1n</span><span class="text-on-surface-variant">/</span><span class="text-on-surface-variant">3. Nh\u1EADn V\xE9</span></div></div><div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start"><div class="lg:col-span-8">`);
...
//# sourceMappingURL=seat-DlENW1Vi.mjs.map
