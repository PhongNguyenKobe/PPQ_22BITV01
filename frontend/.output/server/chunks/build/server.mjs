import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, shallowRef, getCurrentInstance, provide, cloneVNode, h, createElementBlock, toRaw, computed, isRef, isReactive, toRef, hasInjectionContext, inject, ref, reactive, effectScope, getCurrentScope, onScopeDispose, watch, nextTick, toRefs, markRaw, defineAsyncComponent, unref, shallowReactive, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, mergeProps, withCtx, isReadonly, useSSRContext, isShallow } from 'vue';
import { p as parseURL, e as encodePath, l as decodePath, m as hasProtocol, n as isScriptProtocol, o as joinURL, w as withQuery, q as sanitizeStatusCode, r as getContext, $ as $fetch, v as defu, x as createHooks, f as createError$1, y as executeAsync } from '../_/nitro.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-j_FEgoqx.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BHCk4Esa.mjs'));
...
export { _export_sfc as _, __nuxt_component_2 as a, useNuxtApp as b, useRuntimeConfig as c, defineStore as d, entry_default as default, encodeRoutePath as e, nuxtLinkDefaults as f, navigateTo as n, resolveRouteObject as r, storeToRefs as s, tryUseNuxtApp as t, useRouter as u };
