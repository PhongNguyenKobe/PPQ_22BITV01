...
function mapBackendRoleToFrontend(roleCodes: string[]): UserProfile["role"] {
  ...
  if (roleCodes.includes("BRANCH_ADMIN") || roleCodes.includes("STAFF"))
    return "branch-admin";
  return "customer";
}
...
export function mapBackendAdminUserToProfile(
...
export const adminBackendService = {
  ...
  async updateUserRole(
    userId: string,
    roleCode: "CUSTOMER" | "BRANCH_ADMIN" | "STAFF" | "SUPER_ADMIN",
    branchId?: string | null,
  ): Promise<UserProfile> {
    const res = await apiClient.patch<BackendAdminUser>(
...
export const mockMovies: Movie[] = [
  {
    ...
    format: ["IMAX", "2D", "4DX"],
    poster:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuCy_q8U1fieQE3DjTaCLWjqCQwXrCZsXiBLHjmnmmQdpc2TKR3LyPghhABCJehjXUTnjJhNCXW204MFqaYE2F6SAkFM6Vcp0vNHexNphDczN1DfA7c4fQ83Pv_jeLe2omU0PmLCKdHJdLx_iKpnLYBNbgTbwQQMYq98mFTfrmA3tvGk4-TJWgr1DWg5lN4LBp0CtwANVnKNuRgWi-Dq5oCu-DNTlS1L5qxfTFgfiLAypE-U8kW4wGO2g-SRAcKQaGW6MHIKMPq5G1dl",
    trailer: "https://www.youtube.com/embed/Way9Dexny3w",
    description:
      "Trong một thế giới nơi thực tại ảo thay thế cuộc sống thật, một lập trình viên phát hiện ra lỗ hổng có thể thay đổi nhân loại mãi mãi.",
    duration: 120,
  ...
  },
  {
    ...
    format: ["2D", "IMAX"],
    poster:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuC5YIBPGdjmKme0u144QgxhV8kFAUzB1QpOuRZIMzt8bMyzaU8hQ5DjgSFoTUmM3f04pqnUAPat8sFJslT3l9Mk392K-C10eXrEz04WIwE9EWxd8XaKP9U26ATs1zj7tdZ2UESEna1GM0Kjh71Y2obVEe5h50Aq_u8rjZ42vBtcE8OnuHEGuYp7VFfcR-Xwly_ZqfFgungKXhbizP94owkAIWGm0hU8hJ_CWKer9U-8VR9pyK5XTkG1na7YoUIIdSUbrXO3BKipdHbV",
    trailer: "https://www.youtube.com/embed/Way9Dexny3w",
    description:
      "Sự trỗi dậy của một ý thức nhân tạo vượt trội trong cơ thể sinh học lai, buộc con người phải định nghĩa lại ý nghĩa của sự sống.",
    duration: 135,
    ...
    isFeatured: true,
    aiMatchReason:
      "Bạn đã xem các phần trước của Trí Tuệ Nhân Tạo. AI đề xuất suất chiếu lúc 20:15 có tỷ lệ ghế đẹp cao.",
  },
  {
    id: "3",
    title: "Vũ Trụ Vô Tận",
    ...
    format: ["IMAX", "2D"],
    poster:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuAsXsmNAsVQJkGnBMFt8hVCOL3StF6Rpvk3zVnk32ITcyyDxsNGnR7UtMmJAhGIFYvawOokSkMOTMYIp2CwMUaiFN9tLkWhOCmnnIAWk-sxhiUj1WelW_trFZGAOEqI9YAYiXWITCmprEIqzsP7UOqcs4aB4EBCyzYc2nW-Nrr4FpdO-_u0ItPOzjjxSua2eKTU2QlwqaWuNNFxatNAXcpYXpjLXqDLaKX1h3aYS6WFGj5baKwnkYh_CFBZj7APY2TvvZGl6XZGfo6r",
    trailer: "https://www.youtube.com/embed/zSWdZVtXT7E",
    description:
      "Hành trình vượt qua các hố đen và ranh giới không gian để cứu rỗi nhân loại.",
    duration: 145,
  ...
  },
  {
    ...
    format: ["2D"],
    poster:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuCrvOfBYGCh68jDrlUdA7mR9ysFqNwPqXy8FfHZDzq5IDhu1LaAKCnpZP_6r2RAuaf8U0pA2DwNq6n7-MecZPLYhOSpf4ChD3W1zkUYnn54td6jsxTo5mKTxEwHQH6lN5miOIQVr4UEz4CrvJNQyDm0vHtLxC5fC9X3sDVl80ssQ0th2KyjUgr3mJVU_PhROH7v7G_1MLeNRvdeq72eGHyz-7gFY-f2Y0-uKqqRGMgc_ZeItXtN-o45w6ufWbQfF-hzWLkYPXbjrkRa",
    trailer: "https://www.youtube.com/embed/Way9Dexny3w",
    description:
      "Một thám tử tư đơn độc trong hành trình vạch trần âm mưu đen tối của thế lực ngầm núp bóng chính quyền.",
    duration: 125,
  ...
  },
  {
    ...
    format: ["2D", "3D"],
    poster:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuDtf1Bo44PrFX22Kw9z86OmCD2kSMzYvn9FIBJNyiynU9kzhCUpjS2GrJAS471OpoZbKAdwO09wRpJEYOR1hnFxQZDHbjyzpq1Xqc_a5B4j96Jpkuw8cpDXaeawTNeKvQB7QAFWiQHMCxbUNEDjCedW8_sCwXuqiEmQ51RStuuqli-Edw1FCQoAdMcLsh0NYr_rhcZw6SXoQcSn1bGffo71EUG5coAtD66fcIQ8ZFXqy6DFUytSG6-HPjA7yzx6lllCPH8zHUvbjtRJ",
    trailer: "https://www.youtube.com/embed/Way9Dexny3w",
    description:
      "Chuyến phiêu lưu của những sinh vật kỳ lạ và đầy màu sắc nhằm bảo vệ nguồn sáng của thế giới thần tiên.",
    duration: 95,
  ...
  },
  {
    ...
    format: ["2D", "IMAX"],
    poster:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuBEuXmT3DJgVIS-S5qYDVSEwlpd6AJEdTm4FNE6P_hDsDeIeHw12h3cqL8KUP_ZzJ1NPplkQMXFaDixf1SpqppnIEWvdntszhk32Wxotx-kSzP_-uH2pz6Rsn7jxg6zffbpTFuB8n14uS5xBA3L5LFb69siWHFi2XJCrSxvWL0oEaEXIcib0f9KtUzo32nAlJ9elce75zDdsYybXcDVEI0hAkhEhsAraeg2jRdMadn3UYG3CPCiZSKCREGmO9jCRIiKUfZIOL67qBIA",
    trailer: "https://www.youtube.com/embed/Way9Dexny3w",
    description:
      "Trận chiến sinh tử hào hùng thời trung cổ giữa hai đế quốc hùng mạnh tranh giành ngai vàng.",
    duration: 150,
    ...
    isFeatured: false,
    aiMatchReason:
      "Sử thi chiến tranh hoành tráng, trùng khớp gu phim hành động lịch sử của bạn.",
  },
  {
    id: "8",
    ...
    isFeatured: false,
    aiMatchReason:
      "Kinh dị rùng rợn từ James Wan, được AI đề xuất cho các đêm cuối tuần.",
  },
  {
    id: "9",
    ...
    format: ["2D"],
    poster:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuAMSFtwCei8ZDrs4lICf_3j_TUSGR-62_yVaCzI_F_xPsPZBM8TfEzam-5eorL2CmtoinRaoyarRd9uNLCz4ZYNU83VGHY5A93LOV1bvjguYRd22aLBBDlIoF5b_Xl_MXmXYefjIbEG3KO9mQliQElFKVb91zfE67bSVea4S2vKMg8LGX5dEMhBayMvBYaoaC8mLeCcvSMKE6zLya3kaRyFrfRxnAoL_3keCFEa3QSXmEsRGGgv64V8he0mUxz4B5C6hl5kDL5p79ls",
    trailer: "https://www.youtube.com/embed/Way9Dexny3w",
    description:
      "Mối tình mùa hè lãng mạn đầy tiếng cười của cặp đôi trẻ vô tình gặp nhau tại thành phố Venice xinh đẹp.",
    duration: 108,
...
export const movieService = {
  ...
  async getShowtimes(movieId: string): Promise<Showtime[]> {
    ...
    const res = await apiClient.get<BackendShowtime[]>(
  ...
  async getSeats(showtimeId: string): Promise<Seat[]> {
    ...
    const res = await apiClient.get<BackendSeat[]>(
  ...
  async searchSemantically(query: string): Promise<Movie[]> {
    if (USE_MOCK) {
      ...
      if (
        q.includes("viễn tưởng") ||
        q.includes("vũ trụ") ||
        q.includes("dune") ||
        q.includes("interstellar")
      ) {
        return mockMovies.filter(
          (m) =>
            m.genre.includes("Viễn Tưởng") || m.genre.includes("Cyberpunk"),
        );
      }
      ...
      if (
        ...
        return mockMovies.filter(
          (m) => m.genre.includes("Cyberpunk") || m.genre.includes("Neon-Noir"),
        );
      }
      return mockMovies;
    }

    const res = await apiClient.post<BackendMovie[]>(
  ...
  async processPayment(bookingDetails: {
    ...
    if (USE_MOCK) {
      const showtime = mockShowtimes.find(
        (s) => s.id === bookingDetails.showtimeId,
      );
...
export const aiService = {
  async askChatbot(
    ...
    if (USE_MOCK) {
      ...
      if (
        ...
        return {
          response:
            "Để đặt vé, bạn hãy truy cập mục **Khám phá AI**, chọn phim yêu thích, chọn suất chiếu, sau đó sơ đồ phòng chiếu thông minh sẽ xuất hiện để bạn chọn ghế ngồi và tiến hành thanh toán nhé!",
          action: "NAVIGATE_TO_MOVIES",
        };
      }
      if (
        m.includes("gợi ý") ||
        m.includes("phim nào hay") ||
        m.includes("recommend")
      ) {
        return {
          response:
            "Dựa trên sở thích của bạn, tôi đề xuất xem **Thành Phố Vô Hình: 2050** (Cyberpunk viễn tưởng hoành tráng) hoặc **Trí Tuệ Nhân Tạo: Khởi Nguyên** (Viễn tưởng, tâm lý). Bạn có muốn xem lịch chiếu của bộ phim nào không?",
      ...
      if (m.includes("giá vé") || m.includes("bao nhiêu")) {
        return {
          response:
            "Giá vé tại hệ thống rạp CineAI dao động từ **90.000 VNĐ** cho ghế Standard đến **120.000 - 150.000 VNĐ** cho ghế VIP và ghế Couple. Thành viên CineAI cũng được hưởng ưu đãi giảm giá lên tới 20%!",
        };
      }
      if (m.includes("lịch chiếu") || m.includes("hôm nay")) {
        return {
          response:
            "Hôm nay chúng tôi có các suất chiếu từ chiều tới tối muộn cho các phim hot như **Thành Phố Vô Hình: 2050**, **Trí Tuệ Nhân Tạo: Khởi Nguyên**, **Vũ Trụ Vô Tận**... Bạn muốn kiểm tra suất chiếu ở chi nhánh Hùng Vương hay Sala Q2?",
          action: "NAVIGATE_TO_MOVIES",
        };
      }
      return {
        response:
          "Xin chào! Tôi là CineAI Assistant 🤖. Tôi có thể giúp bạn gợi ý phim, tra cứu lịch chiếu, hướng dẫn chọn ghế hoặc giải đáp các thắc mắc về dịch vụ. Bạn có câu hỏi nào khác không?",
      };
    }
  ...
  ): Promise<{ text: string; parsedAction: string; data?: any }> {
    if (USE_MOCK) {
      ...
      if (randomText.includes("Hình") || randomText.includes("Vô Hình")) {
        ...
        randomText.includes("Trí Tuệ") ||
        randomText.includes("Nhân Tạo")
      ) {
      ...
      return {
        ...
        usersList: [
          ...
          },
          {
            ...
            email: "phongnd@cineai.vn",
            role: "admin",
          },
          {
            id: "u4",
            name: "Võ Toàn Phú",
            email: "phuvt@cineai.vn",
            role: "branch-admin",
            branchId: "b1",
          },
        ],
  ...
  async getBranchAdminStats(branchId: string): Promise<{
    ...
    if (USE_MOCK) {
      return {
        ...
        showtimesList: mockShowtimes.filter((s) =>
          s.branchName.includes("Sala"),
        ),
        promotionsList: [
          {
            code: "AISELECTION",
            discount: 15,
            desc: "Giảm 15% cho phim do AI gợi ý",
            active: true,
          },
          {
            code: "WEEKEND30",
            discount: 10,
            desc: "Giảm 10k/vé dịp cuối tuần",
            active: true,
          },
          {
            code: "STUDENTIMAX",
            discount: 20,
            desc: "Giảm 20% vé IMAX cho học sinh sinh viên",
            active: false,
          },
        ],
      };
