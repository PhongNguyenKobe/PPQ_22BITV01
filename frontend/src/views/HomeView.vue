  ...
  <div class="page-shell">
    ...
    <nav class="topbar">
      ...
      <div class="topbar__actions">
        <!-- Dùng router-link thay href để điều hướng đúng -->
        <button class="button button--solid" @click="router.push('/login')">Sign In</button>
      </div>
    </nav>
    ...
    <main>
          ...
          >
            ...
            <div class="movie-card__content">
              ...
              <div class="movie-card__actions">
                <button class="button button--primary button--block" @click="router.push('/login')">
                  {{ movie.label }}
                </button>
      ...
      <section class="section section--cta" id="theaters">
        ...
        <div class="container cta-block">
          ...
          <button class="button button--primary button--large" @click="router.push('/register')">
            Đăng ký ngay
            <span class="material-symbols-outlined">arrow_forward</span>
          </button>
        </div>
    ...
    <footer class="footer">
      <div class="container footer__inner">
        <div>
          ...
          <p>© 2026 CineAI Studios. Powered by Cinema Intelligence.</p>
        </div>
