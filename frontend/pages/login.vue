...
<template>
  <div class="min-h-[80vh] flex items-center justify-center py-16 px-4">
    ...
    <div class="glass-panel w-full max-w-md rounded-2xl border border-glass-stroke p-8 relative z-10 shadow-2xl">
      ...
      <!-- Role Selector Tabs -->
      <<<<<<< HEAD <div
        class="grid grid-cols-3 gap-2 bg-surface-container-low border border-glass-stroke p-1 rounded-xl mb-6">
        =======
        ...
        <form @submit.prevent="handleLogin" class="space-y-5">
          ...
          <div>
            <label class="block text-xs font-bold uppercase tracking-wider text-on-surface-variant mb-2">Mật
              khẩu</label>
        ...
        <div class="mt-8 border-t border-glass-stroke/40 pt-4">
          <div class="bg-surface-container-low/60 rounded-xl p-3 border border-glass-stroke/50">
            <span class="text-[10px] font-bold uppercase text-secondary tracking-wider block mb-1">💡 Tài khoản thử
              nghiệm
